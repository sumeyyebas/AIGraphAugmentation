...
def graph_load_batch(data_dir,
  ...
  if graph_labels:
    data_graph_labels = np.loadtxt(
        ...
        delimiter=',').astype(int)
    #print("graph_labels : ", data_graph_labels)
...
def create_graphs(graph_type, data_dir='data', noise=10.0, seed=1234):
  ...
  labels = pd.Series(gl)
  class1 = labels[labels==1]
  class2 = labels[labels==2]
  class3 = labels[labels==3]
  graphs_series = pd.Series(graphs)
  
  graphs_1 = graphs_series[labels==1]
  graphs_2 = graphs_series[labels==2]
  graphs_3 = graphs_series[labels==3]
  
  labels_newB_1 = class1[520:]
  labels_newB_2 = class2[140:]
  labels_newB_3 = class3[320:]
